import { TransactionOptions } from '@usedapp/core/dist/esm/src/model/TransactionOptions'
import { useConfig } from '@usedapp/core/dist/esm/src/hooks/useConfig'
...
import { ContractFunctionNames, Falsy, Params, TypedContract } from '@usedapp/core/dist/esm/src/model/types'
...
export function useContractFunction<T extends TypedContract, FN extends ContractFunctionNames<T>>(
    ...
    const send = useCallback(
        async (txIdentifier: any, ...args: Params<T, FN>): Promise<TransactionReceipt | undefined> => {
            if (contract) {
                ...
                const gasLimit =
                    typeof opts === 'object' && Object.hasOwn(opts, 'gasLimit')
                        ? opts.gasLimit
                ...
                const receipt = await promiseTransaction(txIdentifier, contractWithSigner[functionName](...modifiedArgs, modifiedOpts), {
                    safeTransaction: {
                        to: contract.address,
                        value: opts?.value,
