        ...
        <div className={`f_c_l_c r_12 squircle_border m_t_15 how_it_works_box`}>
            ...
            <div className={`f_r_b h_flow`}>
                ...
                <div className={`f_r_l`}>
                    ...
                    <div className={`h_flow_text b`}>{`2. Receive iUSDC`}</div>
                </div>
                ...
                <div className={`f_r_l`}>
                    ...
                    <div className={`h_flow_text b`}>{`3. Withdraw and burn iUSDC`}</div>
                </div>
